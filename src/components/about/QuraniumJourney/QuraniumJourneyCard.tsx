...
const QuraniumJourneyCard: React.FC<CardProps> = ({ event }) => (
  <div>
    <div className="bg-card-border p-[1px] rounded-[20px]">
      <div
        className={`bg-[#0D0419] hover:bg-[#0E002A] w-[400px] rounded-[20px] px-6 py-4 ${
          event.mesh
            ? "bg-[url(/images/about/mesh.png)] bg-contain bg-no-repeat bg-right-bottom"
            : ""
        }`}
      >
