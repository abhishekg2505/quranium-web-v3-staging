      ...
      <div className="relative pt-36 md:pt-60 pb-[320px] w-full">
        ...
        <div className="container mx-auto px-8 md:px-20">
          <div className="w-full text-center md:text-left">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-[30px] md:gap-10">
              {/* Left Text Section */}
              <div>
                <Image
                  src="/images/next-gen-innovators/next-gen-innovators-logo.svg"
              ...
              <div className="flex flex-col items-start space-y-6">
                <h1 className="hero-title mt-7 text-h5 md:text-h4 font-montserrat font-bold text-white  max-w-md">
                  Internship Program for Rising Stars
                </h1>
              </div>
            </div>
          </div>
