...
export default function HeroSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full bg-[url('/images/landl/landl-hero.webp')] bg-cover bg-right sm:bg-center"
    >
      <div className="absolute inset-0 bg-black z-20 hero-overlay" />
      <div className="relative pt-56 pb-[267px] md:pt-64 md:pb-80 w-full">
        ...
        <div className="container mx-auto px-8 md:px-20">
          <div className="w-full text-center md:text-left">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-10">
              ...
              <div>
                <Image
                  src="/images/landl/landl-logo.svg"
