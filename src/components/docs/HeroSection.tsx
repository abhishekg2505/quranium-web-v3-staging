...
export default function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-[#0C0318]">
      <div className="absolute inset-0 bg-black z-20 hero-overlay" />
      <div className="absolute top-[0px] left-[0px] w-[279px] h-[309px] md:w-[579px] md:h-[609px] ">
        <Image src="/images/common/svgicons/left-side.png" alt="icon" fill />
      </div>
      <div className="absolute top-[50px] right-[0px] w-[304px] h-[563px] md:w-[404px] md:h-[653px] ">
        <Image src="/images/common/svgicons/right-side.png" alt="icon" fill />
      </div>

      <div className="relative pt-48 pb-48 md:pt-60 md:pb-60 w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-between lg:items-center gap-10">
              ...
              <div className="flex flex-col items-start space-y-6">
                <p className="text-p1 font-normal lg:max-w-[461px] hero-subtext">
                  Explore the technical, architectural, and ecosystem documents that power the
                  Quranium network. From our whitepaper to wallet and developer tools, this is your
                  gateway to building securely in the quantum era.
                </p>
              </div>
            </div>
          </div>
