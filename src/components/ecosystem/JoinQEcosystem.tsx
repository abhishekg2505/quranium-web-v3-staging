    ...
    <div>
      <div ref={sectionRef} className="px-4 md:px-20 py-10 md:py-20 p-[1px] rounded-[20px]">
        <div className="p-[1px] rounded-[20px] bg-roadshow-stats-border">
          <div className="relative p-10 md:py-40 px-4 md:px-10 rounded-[20px] container mx-auto bg-[url('/images/awareness/calendars.webp')] bg-cover bg-center md:bg-right">
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <div className="mt-[15px] mb-10 p-[10px] bg-[#A47FFF26] rounded-[10px] max-w-[576px] mx-auto flex">
                <Image src="images/ecosystem-new/hand.svg" alt="icon" width={24} height={24} />
                <p ref={buttonRef} className="text-p3 italic text-[#EAEAEA] font-open-sans">
                  If you&rsquo;re a potential partner, collaborator, or media outlet aligned with
                  our mission to build an uncrackable digital world, we&rsquo;d love to hear from
                  you.
                </p>
              </div>
