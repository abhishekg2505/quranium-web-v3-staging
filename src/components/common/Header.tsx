              ...
              {navLinks.map((item, idx) => (
                ...
                >
                  {item.link ? (
                    ...
                    >
                      <span
                        className={`text-p3 font-semibold leading-[26px]  group-hover:text-[#AE87FF] ${
                    ...
                    <div
                      className={`flex items-center gap-2 font-semibold text-p3 leading-[26px] cursor-pointer ${
                        hoveredNavIdx === idx || isParentActive(item)
                          ? "text-[#AE87FF]"
                          : "text-white-1"
                      }`}
