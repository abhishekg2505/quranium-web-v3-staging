      ...
      <div className="space-y-12">
        ...
        <div className="relative w-full">
          ...
          <div className="flex justify-center gap-6 mt-6 md:mt-0 md:block">
            {/* Left Arrow */}
            <div
              className={`group flex align-middle justify-center swiper-prev md:absolute md:-left-7 md:top-1/2 md:transform md:-translate-y-1/2 z-10 bg-background border border-[#999999]  w-10 h-10 rounded-full cursor-pointer ${
            ...
            {/* Right Arrow */}
            <div
              className={`group flex align-middle justify-center swiper-next md:absolute md:-right-7 md:top-1/2 md:transform md:-translate-y-1/2 z-10 bg-background border border-[#999999] w-10 h-10 rounded-full cursor-pointer ${
