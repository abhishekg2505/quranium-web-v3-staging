...
const CampusProgram = () => {
  ...
  return (
    <div>
      <div ref={sectionRef} className="px-4 md:px-20 pb-10 md:pb-[80px] p-[1px]  bg-black">
        <div className="animation-wrapper relative  py-[40px] px-4 md:px-10 container mx-auto bg-[url('/images/community/ctabg.webp')] bg-cover bg-center sm:bg-right rounded-[20px]">
