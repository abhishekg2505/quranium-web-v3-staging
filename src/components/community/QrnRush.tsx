...
const QrnRush = () => {
  ...
  return (
    <div
      id="qrn-rush"
      className="scroll-mt-24 relative px-4 md:px-20 py-10 md:py-[50px] bg-[url('/images/community/qrnmobilebg.webp')] md:bg-[url('/images/community/qrndesktopbg.webp')]  bg-no-repeat bg-center"
