            ...
            >
              <div className="relative w-full h-auto md:h-[350px] bg-[#0C0318]">
                ...
                <div className="bg-roadshow-reverse-border p-[1px] rounded-[20px] h-full">
                  <div className="bg-[url('/images/grant-program/grid.png')] bg-no-repeat bg-right-top bg-[length:150px_150px] bg-[#0C0318] p-6 h-full rounded-[20px] flex flex-col items-start text-left py-16">
