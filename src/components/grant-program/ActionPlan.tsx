                ...
                >
                  <div className="relative w-full">
                    ...
                    <div className="bg-roadshow-reverse-border p-[1px] rounded-[20px]">
                      <div className="bg-[url('/images/grant-program/grid.png')] bg-no-repeat bg-right-top bg-contain bg-[#0D031B] p-6 h-full rounded-[20px] flex flex-col items-start text-left py-10">
