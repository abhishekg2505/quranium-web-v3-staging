export const quraniumteam = [
  {
    ...
    description: [
      ...
      "Kapil has also helped over 20 startups in the Web3 ecosystem with their GTM and Product strategies. He is a distinguished global speaker and author.",
    ],
  },
  {
    ...
    description: [
      ...
      "Yaduvendra plays a pivotal role in shaping the trajectory of blockchain security and the seamless incorporation of quantum computing.",
    ],
  },
  {
    name: "Zeeshan Khan",
  ...
  },
  {
    ...
    description: [
      ...
      "He innovated in Ethereum protocols and DEFI products.",
      "Mohit has trained 300+ engineers in blockchain, making him a pioneer in India’s blockchain scene.",
    ],
  },
  {
    name: "Sylvain Vittecoq",
...

  {
    ...
    description: [
      ...
      "With the mix of agency and entrepreneurship background he has collaborated with over 200 brands, crafting growth strategies & brand experience campaigns for major tech brands like Google, Microsoft, Siemens, Adobe, Oracle, Meta, IBM, and Intel.",
    ],
  },
  {
    name: "Mado Vougadi",
    ...
    description: [
      ...
      "Mado is passionate about employee development, driving HR policy, and managing the entire employee lifecycle from recruitment to offboarding.",
    ],
  },
  {
    name: "Benjamin Shin",
    ...
    description: [
      ...
      "As CEO of a fund company overseeing multiple global CFD exchanges, he managed institutions and funds.",
      "He entered the Web3 industry in 2016, securing investments from major capital firms by leading pivotal roles in over 10 projects spanning M/M, marketing, and listings on top exchanges.",
    ],
  },
  {
    name: "Ian Issa",
...
export const advisors = [
  ...
  },
  {
    ...
    description: [
      ...
      "Michael's ventures also include First Block and bCommerce Labs, incubating digital assets like Aspire.",
      "Previously, he founded Market Wire, a major newswire, and early social media agency SocialRadius.",
    ],
  },
  {
    name: "James Bernard",
