  ...
  const htmlData = `
    ...
    <body style="width=600px">
       <div class="email-container">
        ...
        ${generateBody(name, heroBannerUrl, emailSubject, para1, para2, para3, para4, para5)}
        ${generateFooter(type)}
         </div>
    </div>
    </body>
...
// Header
const LOGO_URL = "https://github.com/Quranium/Assets/blob/main/quraniumLogo.png?raw=true";
...
const TWITTER_IMAGE_URL = "https://github.com/Quranium/Assets/blob/main/socialmedia/x.png?raw=true";
